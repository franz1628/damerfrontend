...
export class ClienteAtributoFiltroComponent {
    ...
    forkJoin( 
      {
        service  : this.service.postIdAtributoFuncionalVariedadValor(this.atributoFuncionalVariedadValor.id),
         serviceCategoriaAtributoTecnico: this.serviceCategoriaAtributoTecnico.postIdAgrupacionCategoria(this.atributoFuncionalVariedad.idClienteAgrupacionCategoria),
         serviceSkuService:this.serviceSkuService.getByCategoria(this.atributoFuncionalVariedad.idClienteAgrupacionCategoria),
  ...
  eligeVariable(e: Event,ind:number) {
    ...
    if(valor=="1"){//SKU 
       this.serviceSkuService.getByCategoria(this.atributoFuncionalVariedad.idClienteAgrupacionCategoria).subscribe(x=>{
